...
{
    public partial class Project_Budget_Information : Form

    {
        MySqlDataAdapter adpt;
        DataTable dt;
        public Project_Budget_Information()
        {
            InitializeComponent();
        ...
        private void Project_Budget_Information_Load(object sender, EventArgs e)
        {
